 ...
 * 
 * Este módulo contém interfaces TypeScript e dados mock para desenvolvimento
 * e testes do sistema de fornecedores.
 * 
 * Interfaces:
 * - Fornecedor: Estrutura de dados de um fornecedor
 * - DocRequisito: Estrutura de dados de um documento requisitado
 * - HistoricoEnvio: Estrutura de dados do histórico de envios
 * 
 * Funções:
 * - buscarDocumentosNecessarios: Busca documentos necessários para uma categoria
 * - enviarDocumentos: Simula envio de documentos
 * - buscarHistoricoEnvios: Busca histórico de envios de um fornecedor
 * 
 * @module app/LIB/mock-data
